...
do
{
    ...
    {
        case 1:
            DbConnection obj = new SqlConnection("SQL");
            ...
            do
            {
                ...
                switch (innerChoice)
                {
                    ...
                    case 1:
                        ...
                        DatabaseCommand db = new DatabaseCommand(inst, obj);
                        db.Execute();
                        break;
        ...
        case 2:
            DbConnection obj1 = new OracleConnection("Oracle");
            ...
            do
            {
                ...
                switch (innerChoice)
                {
                    case 1:
                        ...
                        Console.WriteLine("Enter an instruction");
                        string inst = Console.ReadLine();
                        DatabaseCommand db = new DatabaseCommand(inst,obj1);
                        db.Execute();
                        break;
